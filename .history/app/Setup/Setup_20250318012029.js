...
class Setup extends P5Config {
  ...
  draw() {
    ...
    for (let i = 0; i < this.pipes.length; i++) {
      let pipeX = this.rePositionPipe(i) - this.p5.frameCount * this.speed;
  ...
  rePositionPipe(i) {
    if (i === 0) {
      ...
      return this.p5.windowWidth + this.p5.random(300, 600);
    } else if (i === 2) {
      return this.p5.windowWidth +  this.p5.random(600, 900);
    }
